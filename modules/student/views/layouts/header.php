...
$schoolDetails = \app\models\Student::findOne(\Yii::$app->getRequest()->getCookies()->getValue('studentId'));
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="user-header">
                        ...
                        <p>
                          ...
                          <small><b><?= $schoolDetails->schoolName; ?> - <?= $schoolDetails->school->established_year; ?></b></small>
                        </p> 
                      </li> 
                      <!-- Menu Footer-->
