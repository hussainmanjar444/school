...
$schoolDetails = \app\models\SchoolLibrarian::find()->where(['user_id' => Yii::$app->user->identity->id])->one();
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">  
              ...
              <li><h4><b><?= strtoupper($schoolDetails->schoolName); ?> - <?= strtoupper($schoolDetails->school->municipality->name); ?></b></h4></li>
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="user-header">
                        ...
                        <p>
                          ...
                          <small><b><?= $schoolDetails->school->name; ?> - <?= $schoolDetails->school->established_year; ?></b></small>
                        </p>
                      </li> 
                      <!-- Menu Footer-->
                      <li class="user-footer">
                        <div class="pull-left">
                          <a href="/librarian/profile" class="btn btn-default btn-flat">Profile</a>
                        </div>
