        ...
        <div class="row">
            <div class="col-sm-12 col-md-8"> 
                <div class="inventory-issue-form">
                    ...
                    {
                        echo '<p><a href="/librarian/inventory-issue/issue-new-book?id='.$studentDetails->student_id.'" class="btn btn-info"><i class="fa fa-plus"></i> Issue New Book</a></p>';
                            /*echo "<h3>NOTE * <i>You can't issue same book twice which is already issued by this student.</i></h3>";
                            $model = new InventoryIssue();
                             $form = ActiveForm::begin([  
                                'action' => '/librarian/inventory-issue/issue-new-book?id='.$studentDetails->student_id
                             ]); 
                            ?> 
