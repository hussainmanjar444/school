   ...
   /* public function actionCreate()
    ...
    public function actionSearchBook()
    {
        ...
        if($model->load(Yii::$app->request->get()))
        {
            ...
            if($searchData)
            {
                $msg = "<span style='color:green'>Book ISBN - <b>'".$searchData->isbn."'</b> you are looking for is avaliable in your libaray. <b><a href='/librarian/inventory/assign-existing-book?id=".$searchData->id."'> Click here</a></b> to add this book in your Inventory.</span>";
            }
            else
            {
                $msg = "<span style='color:red'>Book ISBN - <b>'".$model->isbn."'</b> you are looking for is not avaliable in your libaray. <b><a href='/librarian/inventory/assign-new-book?isbn=".$model->isbn."'> Click here</a></b> to add this book in your Inventory.</span>";
            }
        }
