            ...
            <div class="box-body">
                <div class="school-admin-view">
                    ...
                    <p>
                        ...
                        <?php  
                        echo '
                        <a  class = "btn btn-info" href="' . Url::to(['/admin/school-admin/change-password', 'id' => $model->id]) . '">
                     ...
                     ?>
                        <?php 
                            ...
                            if ($model->status == Configuration::ACTIVE) {
                                ...
                                echo Html::a(Yii::t('app', '<i class="fa fa-close"></i> Unconfirm'), ['/admin/school-admin/deactivate-school-admin', 'id' => $model->id], [
                                ...
                                echo Html::a(Yii::t('app', '<i class="fa fa-check"></i> Confirm'), ['/admin/school-admin/activate-school-admin', 'id' => $model->id], [
                                    'class' => 'btn btn-success',
                                    'data-method' => 'post',
