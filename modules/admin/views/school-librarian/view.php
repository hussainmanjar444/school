...
<div class="row">
    <div class="col-sm-12 col-md-12">
        <div class="box"> 
            <div class="box-body">
                <div class="school-librarian-view">
                    ...
                    <p>
                        ...
                        <?php  
                        echo '
                        <a  class = "btn btn-info" href="' . Url::to(['/admin/school-librarian/change-password', 'id' => $model->id]) . '">
                     ...
                     ?>
                        <?php 
                            ...
                            if ($model->status == Configuration::ACTIVE) {
                                ...
                                echo Html::a(Yii::t('app', '<i class="fa fa-close"></i> Unconfirm'), ['/admin/school-librarian/deactivate-school-librarian', 'id' => $model->id], [
                                    'class' => 'btn btn-danger',
                                    'data-method' => 'post',
                                    'data-confirm' => Yii::t('user', 'Are you sure you want to unconfirm this librarian for school?'),
                                ]);
                            } else {
                                echo '<b>School confirmation : </b><span class="text-success">' . Yii::t('app', 'Unconfirmed') . '</span> ';
                                echo Html::a(Yii::t('app', '<i class="fa fa-check"></i> Confirm'), ['/admin/school-librarian/activate-school-librarian', 'id' => $model->id], [
                                    'class' => 'btn btn-success',
                                    'data-method' => 'post',
                                    'data-confirm' => Yii::t('user', 'Are you sure you want to confirm this  librarian for school?'),
                                ]);
                            }
                        ?>
