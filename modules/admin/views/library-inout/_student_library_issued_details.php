...
$totalIssuedModel = InventoryIssue::find()->select(['id', 'inventory_id'])->where(['student_id' => $studentDetails->student_id])->andWhere(['!=','status',Configuration::RETURNED])->all();
        ...
        <div class="row">
            <div class="col-sm-12 col-md-8"> 
                <?php
                   ...
                   $dataProvider->query->andFilterWhere(['student_id'=>$studentDetails->student_id]);
                    ...
                    else
                    {
                            ...
                            $model = new InventoryIssue();
                             $form = ActiveForm::begin([  
                                'action' => '/admin/inventory-issue/issue-new-book?id='.$studentDetails->student_id
                             ]); 
                            ?> 
