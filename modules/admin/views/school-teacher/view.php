            ...
            <div class="box-body">
                <div class="school-teacher-view">
                    ...
                    <p>
                        ...
                        <?php  
                        echo '
                        <a  class = "btn btn-info" href="' . Url::to(['/admin/school-teacher/change-password', 'id' => $model->id]) . '">
                     ...
                     ?>
                        <?php 
                            ...
                            if ($model->status == Configuration::ACTIVE) {
                                ...
                                echo Html::a(Yii::t('app', '<i class="fa fa-close"></i> Unconfirm'), ['/admin/school-teacher/deactivate-school-teacher', 'id' => $model->id], [
                                    'class' => 'btn btn-danger',
                                    'data-method' => 'post',
                                    'data-confirm' => Yii::t('user', 'Are you sure you want to unconfirm this teacher for school?'),
                                ]);
                            } else {
                                echo '<b>School confirmation : </b><span class="text-success">' . Yii::t('app', 'Unconfirmed') . '</span> ';
                                echo Html::a(Yii::t('app', '<i class="fa fa-check"></i> Confirm'), ['/admin/school-teacher/activate-school-teacher', 'id' => $model->id], [
                                    'class' => 'btn btn-success',
                                    'data-method' => 'post',
                                    'data-confirm' => Yii::t('user', 'Are you sure you want to confirm this  teacher for school?'),
                                ]);
                            }
                        ?>
