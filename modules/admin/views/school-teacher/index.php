...
/* @var $searchModel app\models\search\SchoolTeacherSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'School Teachers');
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12">
                    <div class="student-index"> 
                        ...
                        <p>
                            <?= Html::a(Yii::t('app', '<i class="fa fa-plus-circle"></i> Add Teacher'), ['create'], ['class' => 'btn btn-success']) ?>
                        </p>
                            ...
                            [
                                ...
                                'buttons' => [
                                    'resend_password' => function ($url, $model, $key) { 
                                            return '
                                        <a href="' . Url::to(['/admin/school-teacher/change-password', 'id' => $model->id]) . '">
                                        <span title="' . Yii::t('user', 'Update password to school teacher') . '" class="glyphicon glyphicon-envelope">
                                        </span> </a>'; 
                                    },
                                ]
                            ],
