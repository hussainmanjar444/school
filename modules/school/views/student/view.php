                     ...
                     ?>
                        <?php 
                            ...
                            if ($model->status == Configuration::ACTIVE) {
                                ...
                                echo Html::a(Yii::t('app', '<i class="fa fa-close"></i> Unconfirm'), ['/school/student/deactivate-student', 'id' => $model->id], [
                                ...
                                echo Html::a(Yii::t('app', '<i class="fa fa-check"></i> Confirm'), ['/school/student/activate-student', 'id' => $model->id], [
