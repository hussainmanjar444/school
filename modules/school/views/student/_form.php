        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-4">
                ...
                <div class="student-form">
                    ...
                    ])->label('<b style="color:red">'.Yii::t('app', 'Class *').'</b>');?>
                    ...
                    ])->label('<b style="color:red">'.Yii::t('app', 'Section *').'</b>');;?>

                    <?= $form->field($model, 'rollno')->textInput()->label('<b style="color:red">'.Yii::t('app', 'Roll Number *').'</b>'); ?>

                    <?= $form->field($model, 'regno')->textInput()->label('<b style="color:red">'.Yii::t('app', 'Registration Number *').'</b>'); ?> 

                    <?= $form->field($model, 'name')->textInput()->label('<b style="color:red">'.Yii::t('app', 'Name *').'</b>'); ?>
                    <?= $form->field($model, 'gender')->radioList( ['male'=>'Male', 'female' => 'Female'] )->label('<b style="color:red">'.Yii::t('app', 'Gender *').'</b>'); ?> 
...
<?php if($model->isNewRecord){ ?>
                    ...
                    <?= $form->field($model, 'password')->passwordInput()->label('<b style="color:red">'.Yii::t('app', 'Password *').'</b>'); ?> 
