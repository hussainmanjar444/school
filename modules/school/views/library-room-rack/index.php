...
<div class="library-room-rack-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-plus"></i>', ['/school/library-room-rack/create?id='.$model->id],
                    ['role'=>'modal-remote','title'=> 'Create new Library Room Racks','class'=>'btn btn-default']).
                    Html::a('<i class="glyphicon glyphicon-repeat"></i>', ['/school/library-room/view?id='.$model->id],
            ...
            'panel' => [
                ...
                'after'=>BulkButtonWidget::widget([
                            'buttons'=>Html::a('<i class="glyphicon glyphicon-trash"></i>&nbsp; Delete All',
                                ["/school/library-room-rack/bulk-delete"] ,
                                [
