...
$schoolDetails = \app\models\School::findOne(\Yii::$app->getRequest()->getCookies()->getValue('schoolId'));
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="user-header">
                        ...
                        <p>
                          ...
                          <small><b><?= $schoolDetails->name; ?> - <?= $schoolDetails->established_year; ?></b></small>
                        </p>
                      </li> 
                      <!-- Menu Footer-->
                      <li class="user-footer">
                        <div class="pull-left">
                          <a href="/school/profile" class="btn btn-default btn-flat">Profile</a>
                        </div>
