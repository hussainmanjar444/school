                            ...
                            [
                                ...
                                'buttons' => [
                                    'resend_password' => function ($url, $model, $key) { 
                                            return '
                                        <a data-method="POST" data-confirm="' . Yii::t('user', 'Are you sure?') . '" href="' . Url::to(['/admin/user-action/resend-password', 'id' => $model->user->id]) . '">
                                        <span title="' . Yii::t('user', 'Generate new password to user') . '" class="glyphicon glyphicon-envelope">
                                        </span> </a>'; 
                                    },
                                ]
                            ],
