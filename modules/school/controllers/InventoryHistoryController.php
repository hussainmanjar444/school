...
use app\models\search\InventoryHistorySearch;
    ...
    public function actionCreate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new InventoryHistory",
                ...
                $modelInventory = Inventory::findOne($id);
                $modelInventory->quantity += $model->quantity;
                $modelInventory->avaliable_quantity += $model->quantity;
                $modelInventory->save(false);
                return [
                    'forceReload'=>'#crud-datatable-pjax',
                    'title'=> "Create new InventoryHistory",
                    'content'=>'<span class="text-success">Create InventoryHistory success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update InventoryHistory #".$id,
