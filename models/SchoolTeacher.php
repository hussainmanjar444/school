...
class SchoolTeacher extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['school_id','name', 'email_selection', 'password', 'address_p', 'address_t', 'gender', 'blood_group', 'province_p', 'district_p', 'municipality_p', 'ward_p', 'province_t', 'district_t', 'municipality_t', 'ward_t'], 'required'],
    ...
    /**
     * {@inheritdoc}
     * @return \app\models\activeQuery\SchoolTeacherQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\models\activeQuery\SchoolTeacherQuery(get_called_class());
    }
}
