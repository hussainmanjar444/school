...
class BookAuthor extends \yii\db\ActiveRecord
{
    ...
    /**
     * {@inheritdoc}
     * @return \app\models\activeQuery\BookAuthorQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\models\activeQuery\BookAuthorQuery(get_called_class());
    }
}
