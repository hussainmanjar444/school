...
/**
 * This is the model class for table "book_vendor".
 *
 * @property int $id
 ...
 */
class BookVendor extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * {@inheritdoc}
     * @return BookVendorQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\models\activeQuery\BookVendorQuery(get_called_class());
    }
}
